              ...
              <Card className="border-slate-200 shadow-sm">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="mt-2 space-y-1 text-sm text-slate-600">
                        ...
                        {selectedClient.nif && <p className="text-xs text-slate-500">NIF: {selectedClient.nif}</p>}
                      </div>
                    </div>
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-4 border-t border-slate-100 pt-4 md:grid-cols-4">
                    ...
                    <div>
                      <p className="text-xs text-slate-500">Section / Îlot</p>
                      <p className="font-medium text-slate-900">
                        {selectedClient.section || "-"} / {selectedClient.ilot || "-"}
                      </p>
                    </div>
                  </div>
                </CardContent>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label>Section</Label>
              <Input value={form.section} onChange={(e) => setForm({ ...form, section: e.target.value })} placeholder="Ex: A" />
            </div>
            <div>
              <Label>Îlot</Label>
              <Input value={form.ilot} onChange={(e) => setForm({ ...form, ilot: e.target.value })} placeholder="Ex: 12" />
            </div>
            <div className="col-span-2">
