...
function selectedFromDom(){
  const remembered=(window as any).__urbatecSelectedParcel as Parcel|null|undefined;
  if(remembered?.geometry&&remembered?.properties)return remembered;
